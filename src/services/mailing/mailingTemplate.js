...
var options = {
    viewEngine : {
        ...
        layoutsDir: 'src/services/mailing/templates/', // location of handlebars templates
        defaultLayout: 'template', // name of main template
        partialsDir: 'src/services/mailing/templates/', // location of your subtemplates aka. header, footer etc
    },
    viewPath: 'src/services/mailing/templates/',
    extName: '.hbs'
    };
...
const handlebarOptions = {
    viewEngine: {
        extName: '.hbs',
        partialsDir: 'src/services/mailing/templates',
        layoutsDir: 'src/services/mailing/templates',
        defaultLayout: 'ganaste.handlebards',
    },
    viewPath: 'src/services/mailing/templates',
    extName: '.hbs',
};
